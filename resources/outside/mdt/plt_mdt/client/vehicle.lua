...
-- Resource: plt_mdt  —  Client-side vehicle logic
-- =============================================================================
...
-- the client-side vehicle logic lives in another file, or this module was
-- intentionally left empty (all vehicle operations handled server-side).
-- =============================================================================
...
--     If vehicle CRUD operations are expected, they are missing from this file.
