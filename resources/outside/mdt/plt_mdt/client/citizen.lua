-- =============================================================================
-- citizen.lua  (deobfuscated from decompiled SHX* form)
-- Resource: plt_mdt  —  Client-side citizen logic
-- =============================================================================
...
-- the client-side citizen logic lives in another file, or this module was
-- intentionally left empty (all citizen operations handled server-side).
-- =============================================================================
...
--     If citizen CRUD operations are expected, they are missing from this file.
