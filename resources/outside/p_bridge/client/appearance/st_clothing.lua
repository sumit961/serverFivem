if (Config.Appearance == 'auto' and not checkResource('st_clothing')) or (Config.Appearance ~= 'auto' and Config.Appearance ~= 'st_clothing') then
    return
end
...
if Config.Debug then
    lib.print.info('[Appearance] Loaded: st_clothing')
end

Bridge.Appearance = {}

Bridge.Appearance.fetchCurrentSkin = function()
    return exports['st_clothing']:getPedAppearance()
end

Bridge.Appearance.fetchDatabaseSkin = function()
    local databaseSkin = exports['st_clothing']:getPedAppearance()
...
Bridge.Appearance.setPlayerSkin = function(skinData)
    ...
    exports['st_clothing']:setPlayerAppearance(skinData)
...
Bridge.Appearance.setPlayerClothing = function(clothingData)
    ...
    exports['st_clothing']:setPedComponents(clothingData.components)
    exports['st_clothing']:setPedProps(clothingData.props)
