...
local ADDITIVE_COLUMNS = {
    ...
    cm_family_bank_log = {
        ...
        { name = 'category',      ddl = "`category` VARCHAR(32) NOT NULL DEFAULT 'deposit' AFTER `direction`" },
...
function CMFamilyDeleteFamilyRows(familyId)
    ...
    local statements = {
        ...
        { query = 'DELETE FROM cm_family_event_cooldowns WHERE family_id = ?', values = { familyId } },
