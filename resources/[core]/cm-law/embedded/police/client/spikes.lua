...
function PoliceDeploySpike()
    ...
    -- (PoliceConfig.SpikeStrips.PlacementTimeoutMs) -- without this, the server
    ...
    PoliceBeginObjectPlacement({
        model = PoliceConfig.SpikeStrips.Model,
                        ...
                        if #(vehCoords - stripCoords) <= 3.0 then
                            for boneName, tyreIndex in pairs(wheelTyreIndex) do
                                ...
                                if boneIndex ~= -1 then
                                    ...
                                    if #(boneCoords - stripCoords) <= (PoliceConfig.SpikeStrips.BurstDistance or 0.6) then
