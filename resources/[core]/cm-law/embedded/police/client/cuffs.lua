...
RegisterKeyMapping('policecuffkey', 'Police: Cuff/uncuff nearest target', 'keyboard', tostring(PoliceConfig.CuffKey or 'X'))
...
local function draggedSuspectNearVehicle(vehicle)
    ...
    local maxDistance = PoliceConfig.Cuffs.VehicleSeatDistance or 6.0
