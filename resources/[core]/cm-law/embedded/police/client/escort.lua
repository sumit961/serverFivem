...
local function rescan()
    ...
    local vehicleDistance = PoliceConfig.Cuffs.VehicleSeatDistance or 6.0
    ...
    local targetServerId = nearestCuffedPlayer(myCoords, PoliceConfig.Cuffs.InteractDistance or 2.5)
