...
exports('PoliceLegacyAdminGetArmory', function(src)
    src = tonumber(src)
    local permitted = false
    pcall(function() permitted = exports[PoliceConfig.AdminResource]:HasPermission(src, PoliceConfig.AdminPermission) == true end)
...
exports('PoliceLegacyAdminConfigureArmory', function(src, _, data)
...
lib.callback.register('cm-police:server:loadArmoryStock', function(src)
    ...
    if not PoliceLegacyRateLimit(src, 'police_armory_load_stock', 2000) then return false, 'Please wait.' end
