...
Config.Organizations = {
    sahp = {
        ...
        ranks = {
            { tier = 12, name = 'Commissioner', leader = true, permissions = commandPermissions },
            { tier = 9, name = 'Captain', permissions = commandPermissions },
            { tier = 6, name = 'Sergeant', permissions = supervisorPermissions },
            { tier = 3, name = 'Trooper', permissions = memberPermissions },
    ...
    sheriff = {
        ...
        ranks = {
            { tier = 12, name = 'Sheriff', leader = true, permissions = commandPermissions },
            { tier = 9, name = 'Undersheriff', permissions = commandPermissions },
            { tier = 6, name = 'Sergeant', permissions = supervisorPermissions },
            { tier = 3, name = 'Deputy', permissions = memberPermissions },
            { tier = 1, name = 'Cadet', permissions = recruitPermissions },
        },
    },
    fib = {
        ...
        plainclothesMinTier = 3,
        serviceNpc = { name = 'Agent Monroe', role = 'FIB Reception', model = 's_m_m_fiboffice_01' },
        ranks = {
            { tier = 12, name = 'Director', leader = true, permissions = commandPermissions },
            { tier = 9, name = 'Deputy Director', permissions = commandPermissions },
            { tier = 6, name = 'Special Agent in Charge', permissions = supervisorPermissions },
            { tier = 3, name = 'Special Agent', permissions = memberPermissions },
    ...
    army = {
        ...
        ranks = {
            { tier = 12, name = 'General', leader = true, permissions = commandPermissions },
            { tier = 9, name = 'Colonel', permissions = commandPermissions },
            { tier = 6, name = 'Major', permissions = supervisorPermissions },
            { tier = 3, name = 'Sergeant', permissions = memberPermissions },
...
Config.Permissions = {
    ...
    ['law.vehicle'] = 'Use organization fleet vehicles',
