// cm-carplay web UI -- renders the whole tablet from state as an HTML string.
// Classic script (no import/export); depends on window.CarPlayState
// (state.js, loaded before this file); exposes window.CarPlayViews.

(function () {
  const { clockLabel, formatDuration, weatherLabel } = window.CarPlayState;
  ...
  function header(state) {
    ...
    return `<header class="topbar">
      ...
      <div class="topbar-status"><span class="status-dot"></span><span>Connected</span><span class="topbar-divider"></span><span id="clock-label">${clockLabel(state.time)}</span></div>
